...
export const STR = {
  ...
  timer: {
    ...
    saveFailed: 'บันทึกไม่สำเร็จ เวลาที่จับไว้ยังอยู่ ลองกดบันทึกอีกครั้ง',
  ...
  settings: {
    ...
    reminderWebOnly: 'เวอร์ชันเว็บตั้งการแจ้งเตือนไม่ได้ — ค่าที่ตั้งไว้จะถูกบันทึกและใช้งานบนแอปมือถือ',
    versionTitle: 'เวอร์ชันของแอป',
    versionHint: 'ใช้เทียบกับเว็บพรีวิวว่าเป็น build เดียวกันไหม — ถ้ารหัสตรงกันคือโค้ดชุดเดียวกัน',
    versionDev: 'รันจากเครื่องพัฒนา (ยังไม่ผ่าน CI)',
  },
  ...
  common: {
    ...
    yesterday: 'เมื่อวาน',
    back: 'ย้อนกลับ',
    initFailed: 'เริ่มระบบไม่สมบูรณ์ — ชื่อกิจกรรมอาจแสดงไม่ครบ และการซิงก์ถูกระงับไว้เพื่อกันข้อมูลเสียหาย',
  },
} as const;
